...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BucketProvider) DeepCopyInto(out *BucketProvider) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BucketProvider.
func (in *BucketProvider) DeepCopy() *BucketProvider {
	if in == nil {
		return nil
	}
	out := new(BucketProvider)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *BucketProvider) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BucketProviderList) DeepCopyInto(out *BucketProviderList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]BucketProvider, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BucketProviderList.
func (in *BucketProviderList) DeepCopy() *BucketProviderList {
	if in == nil {
		return nil
	}
	out := new(BucketProviderList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *BucketProviderList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BucketProviderSpec) DeepCopyInto(out *BucketProviderSpec) {
	*out = *in
	out.AccessKey = in.AccessKey
	out.SecretKey = in.SecretKey
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BucketProviderSpec.
func (in *BucketProviderSpec) DeepCopy() *BucketProviderSpec {
	if in == nil {
		return nil
	}
	out := new(BucketProviderSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BucketServiceAccountList) DeepCopyInto(out *BucketServiceAccountList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]BucketServiceAccount, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *BucketServiceAccountList) DeepCopy() *BucketServiceAccountList {
	...
	out := new(BucketServiceAccountList)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BucketServiceAccountSpec) DeepCopyInto(out *BucketServiceAccountSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BucketServiceAccountSpec.
func (in *BucketServiceAccountSpec) DeepCopy() *BucketServiceAccountSpec {
	if in == nil {
		return nil
	}
	out := new(BucketServiceAccountSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BucketServiceAccountStatus) DeepCopy() *BucketServiceAccountStatus {
	...
	out := new(BucketServiceAccountStatus)
	in.DeepCopyInto(out)
	return out
}
